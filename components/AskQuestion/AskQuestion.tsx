...
// import styles for this module only
    ...
    <div className={styles.explain}>
      ...
      <div className={'panel ' + styles.output}>
        <div className="title">
          <h3>Ask me please</h3>
          <p>
            Got a question? Ask our smart helper any question and he&rsquo;ll try to help you out!
          </p>
        </div>
        ...
        <div className={styles.chat}>
          {messages.map((message, index) => {
            return (
              <output key={index}>
                <strong>{message.role === 'assistant' ? 'Wilson' : 'You'}</strong>
                <div>
        ...
        <form onSubmit={submit}>
          <input
            ...
            placeholder="e.g. Can we predict random number?"
          />
